...
<html lang="en">
    ...
    <main class="teez Expand product-page">
        <section class="container">
            ...
            <section class="row">
                <form class="form-horizontal ac-custom ac-checkbox ac-cross" role="form" autocomplete="off" enctype="multipart/form-data" name="order_form" id="order_form">
                    <section class="col-md-4">
                        ...
                        <br>
                        <div class="form-group">
                            <button type="button"  onclick="order()" class="btn btn-primary square-btn-long pull-left intro-font">I want this</button>
                        </div>
                    ...
                    <section class="col-md-8">
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <select class="form-control tee-text-light" name="size">
                                    <option>Small</option>
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-lg-1 control-label" style="font-weight:600">:</label>
                            <div class="col-lg-6">
                                <select class="form-control tee-text-light" name="color">
                                    <option>Green</option>
                                    <option>Black</option>
                                    <option>Red</option>
                                    <option>White</option>
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-lg-1 control-label" style="font-weight:600">:</label>
                            <div class="col-lg-6">
                                <select class="form-control tee-text-light" name="type">
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-lg-1 control-label" style="font-weight:600">:</label>
                            <div class="col-lg-6">
                                <select class="form-control tee-text-light" name="gender">
                                    <option>Male</option>
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-lg-1 control-label" style="font-weight:600">:</label>
                            <div class="col-lg-2">
                                <input type="number" class="form-control text-center tee-text-light" value="1" name="qty">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <label class="col-lg-1 control-label" style="font-weight:600">:</label>
                            <div class="col-lg-6">
                                <select class="form-control tee-text-light" name="body_type">
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-lg-1 control-label" style="font-weight:600">:</label>
                            <div class="col-lg-6">
                                <textarea name="details" class="tee-text-light" style="width:100%;height:100px;resize:none;" ></textarea>
                            </div>
                        </div>
    ...
    <script>
        ...
        function order() {
            if ($("#order_form").valid()) {
                $.post('<?php echo site_url(); ?>/shop/orderSend', $('#order_form').serialize(), function(msg) {
                    if (msg == 1) {
                        toastr.success("Successfully order sent !!", "Jäger");///////////////////////////////////////////////////////////////////////////
                    } else {
