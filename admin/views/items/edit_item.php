    ...
    <div class="modal-body" style="background-color: #ffffff">
        ...
        <div class="form-group">
            ...
            <select id="colour" class="form-control" name="colour">
                ...
                <option value="Purple" <?php if ($item->ItemType == "Purple") { ?> selected="true" <?php } ?>>Purple</option>
                <option value="Brown" <?php if ($item->ItemType == "Brown") { ?> selected="true" <?php } ?>>Brown</option>
            </select>
        </div>
        ...
        <div class="form-group">
            <label for="type">Type</label>
             <?php
            $t_user = explode(',', $item->ItemFor);
            ?>
            <input type="checkbox" name="type_b[]" <?php if (in_array('Girls', $t_user)) { ?> checked="true" <?php } ?> value="Girls"/>Girls
            <input type="checkbox" name="type_b[]" <?php if (in_array('Guys', $t_user)) { ?> checked="true" <?php } ?> value="Guys"/>Guys
        </div>
